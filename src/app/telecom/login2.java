...
public class login2 extends JFrame {
	...
	public login2() throws IOException {
		...
		user.setBorder(new MatteBorder(0, 0, 2, 0, (Color) new Color(0, 0, 139)));
		...
		pass.setBorder(new MatteBorder(0, 0, 2, 0, (Color) new Color(0, 0, 139)));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String sql ="Select * from telecom where Username='"+user.getText()+"' and Password ='"+RegPassword+"'";
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				register2 hframe = new register2();
