...
public class register2 extends JFrame {
	...
	public register2() {
		...
		registerr.setBounds(205, 50, 298, 56);
		...
		txtUsername.setBorder(new MatteBorder(0, 0, 2, 0, (Color) new Color(0, 0, 139)));
		...
		txtPassword.setBorder(new MatteBorder(0, 0, 2, 0, (Color) new Color(0, 0, 139)));
		...
		txtConfirmPassword.setBorder(new MatteBorder(0, 0, 2, 0, (Color) new Color(0, 0, 139)));
		...
		txtEmail.setBorder(new MatteBorder(0, 0, 2, 0, (Color) new Color(0, 0, 139)));
		...
		img.setBounds(28, 13, 189, 134);
		img.setIcon(new ImageIcon("img/telecom.png"));
	...
	private Boolean RegisterData()
	{
		...
		try {
			...
			// SQL Insert
			String sql = "INSERT INTO telecom "
